...
public class TmpFunction2Fragment extends BaseFragment {

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Tlog.v(TAG, " TmpFunction2Fragment onCreate() ");
    }
    ...
    protected View inflateView() {
        Tlog.v(TAG, " TmpFunction2Fragment inflateView() ");
        View view = View.inflate(getActivity(), R.layout.framgment_function_two,
                null);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        Tlog.v(TAG, " TmpFunction2Fragment onCreateView() ");
    ...
    public void onDestroyView() {
        super.onDestroyView();
        Tlog.v(TAG, " TmpFunction2Fragment onDestroyView() ");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Tlog.v(TAG, " TmpFunction2Fragment onDestroy() ");
    }

    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Tlog.v(TAG, " TmpFunction2Fragment onActivityResult ");
